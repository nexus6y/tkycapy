...
```
┌──────────────────────────────────────────────┐
│  TOP NAVBAR (horizontal, fixed, h=50px)       │
│  [折叠按钮] [面包屑] [语言] [用户头像] [搜索] [帮助] │
├────────┬─────────────────────────────────────┤
...
│        │  └────────────────────────────────┘  │
│        │                                      │
│w=220px │  (w=剩余宽度, min-w=980px)           │
└────────┴─────────────────────────────────────┘
│              THEME DRAWER (右侧抽屉, 主题风格设置)   │
└──────────────────────────────────────────────────────┘
```
...
系统采用**双层菜单**：
1. **顶部水平菜单** — 12 个一级模块，点击切换侧边栏内容
2. **侧边栏垂直菜单树** — 显示当前模块的完整子菜单树（el-menu, mode=vertical, 支持多级展开）
