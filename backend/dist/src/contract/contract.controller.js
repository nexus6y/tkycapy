...
let ContractController = class ContractController {
    ...
    async findAll(status, code, name, type, page = 1, pageSize = 20) {
    ...
    async create(dto) {
        const tenantId = await this.getTenantId();
        return this.prisma.contract.create({ data: { ...dto, tenantId } });
    }
    async update(id, dto) {
    ...
    async submit(id) {
        return this.prisma.contract.update({ where: { id }, data: { approvalStatus: 'SUBMITTED' } });
    }
    async withdraw(id) {
        return this.prisma.contract.update({ where: { id }, data: { approvalStatus: 'WITHDRAWN' } });
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ContractController.prototype, "submit", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ContractController.prototype, "withdraw", null);
