...
let ProductionOrderController = class ProductionOrderController {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    async tid() { return (await this.prisma.tenant.findUniqueOrThrow({ where: { code: 'default' } })).id; }
    async findAll(status, biz, code, page = 1, pageSize = 30) {
        const tenantId = await this.tid();
        const where = { tenantId };
        if (status)
            where.approvalStatus = status;
        if (biz)
            where.businessStatus = biz;
        if (code)
    ...
    async remove(id) { await this.prisma.productionOrder.delete({ where: { id } }); return { message: '删除成功' }; }
    async submit(id) { return this.prisma.productionOrder.update({ where: { id }, data: { approvalStatus: 'SUBMITTED' } }); }
};
exports.ProductionOrderController = ProductionOrderController;
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)('status')),
    __param(1, (0, common_1.Query)('biz')),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ProductionOrderController.prototype, "create", null);
__decorate([
    (0, common_1.Put)(':id'),
    ...
    __metadata("design:returntype", Promise)
], ProductionOrderController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ProductionOrderController.prototype, "remove", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ProductionOrderController.prototype, "submit", null);
exports.ProductionOrderController = ProductionOrderController = __decorate([
    (0, common_1.Controller)('production-orders'),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], ProductionOrderController);
//# sourceMappingURL=production-order.controller.js.map