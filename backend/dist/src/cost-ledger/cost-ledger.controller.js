...
exports.CostLedgerController = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma/prisma.service");
let CostLedgerController = class CostLedgerController {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    async tid() { return (await this.prisma.tenant.findUniqueOrThrow({ where: { code: 'default' } })).id; }
    async findAll(type, page = 1, pageSize = 30) {
...
], CostLedgerController);
//# sourceMappingURL=cost-ledger.controller.js.map