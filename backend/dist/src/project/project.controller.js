...
let ProjectController = class ProjectController {
    ...
    async findAll(status, code, name, page = 1, pageSize = 20) {
    ...
    async submit(id) {
        return this.prisma.project.update({ where: { id }, data: { approvalStatus: 'SUBMITTED' } });
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ProjectController.prototype, "submit", null);
