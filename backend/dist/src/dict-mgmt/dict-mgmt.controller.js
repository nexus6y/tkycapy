...
let DictController = class DictController {
    ...
    async findOne(id) { return this.prisma.dictionary.findUniqueOrThrow({ where: { id } }); }
    async create(dto) { return this.prisma.dictionary.create({ data: dto }); }
    async update(id, dto) { return this.prisma.dictionary.update({ where: { id }, data: dto }); }
    async remove(id) { await this.prisma.dictionary.delete({ where: { id } }); return { message: '删除成功' }; }
};
...
//# sourceMappingURL=dict-mgmt.controller.js.map