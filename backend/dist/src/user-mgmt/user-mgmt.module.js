...
const role_mgmt_controller_1 = require("./role-mgmt.controller");
...
exports.UserMgmtModule = UserMgmtModule = __decorate([
    (0, common_1.Module)({ controllers: [user_mgmt_controller_1.UserMgmtController, role_mgmt_controller_1.RoleMgmtController] })
], UserMgmtModule);
