...
let OutboundOrderController = class OutboundOrderController {
    ...
    async remove(id) { await this.prisma.outboundOrder.delete({ where: { id } }); return { message: '删除成功' }; }
};
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], OutboundOrderController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], OutboundOrderController.prototype, "remove", null);
