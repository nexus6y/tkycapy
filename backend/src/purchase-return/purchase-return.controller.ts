...
export class PurchaseReturnController {
  ...
  @Post() async create(@Body() dto: any) { const tenantId = await this.tid(); return this.prisma.purchaseReturn.create({ data: { ...dto, tenantId } as any }); }
  @Put(':id') async update(@Param('id') id: string, @Body() dto: any) { return this.prisma.purchaseReturn.update({ where: { id }, data: dto as any }); }
