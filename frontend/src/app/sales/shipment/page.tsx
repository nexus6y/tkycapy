...
export default function SalesShipmentPage() {
  ...
  const doDel=async()=>{if(!del)return;try{await api.delete(`/sales-shipments/${del}`);setDel(null);fetch();}catch(e:any){toast(e.response?.data?.message||'删除失败','error');}};
