...
export default function MaterialPage() {
  ...
  const doDel=async()=>{if(!del)return;try{await api.delete(`/materials/${del}`);setDel(null);fetch();}catch(e:any){toast(e.response?.data?.message||'删除失败','error');}};
