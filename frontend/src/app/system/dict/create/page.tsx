...
export default function DictCreate(){const router=useRouter();const [f,setF]=useState({code:'',name:'',value:'',type:'',status:'ACTIVE'});
const save=async()=>{await api.post('/dictionaries',f);router.push('/system/dict');};
return(<FormLayout title="新增字典" onSave={save} sections={[{id:'b',title:'基本信息'}]} activeSection="b"><FormSection id="b" title="基本信息"><FormGrid>
