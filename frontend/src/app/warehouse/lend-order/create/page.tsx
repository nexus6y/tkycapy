...
export default function LCreate(){const router=useRouter();
const [f,setF]=useState({orderNo:'',type:'LEND',materialId:'',materialCode:'',materialName:'',quantity:'',borrower:'',borrowDate:'',expectedReturn:''});
...
<FormField label="借出单号"><Input className={FI} value={f.orderNo} onChange={e=>setF({...f,orderNo:e.target.value})} placeholder="留空自动生成"/></FormField>
