...
const save=async()=>{try{await api.put('/transfer-orders/'+id,f);router.push('/warehouse/transfer-out');}catch(e:any){alert(e.response?.data?.message||'保存失败');}};
