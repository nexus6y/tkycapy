...
const [f,setF]=useState({orderNo:'',type:'OUT',materialId:'',materialCode:'',materialName:'',quantity:'',fromWarehouseId:'',fromWarehouseCode:'',fromWarehouseName:'',toWarehouseId:'',toWarehouseCode:'',toWarehouseName:''});
...
<FormField label="调出仓库"><EntitySelect entity="warehouse" value={f.fromWarehouseId} onChange={(id,w)=>{setF({...f,fromWarehouseId:id,fromWarehouseCode:w.code||'',fromWarehouseName:w.name||''});}}/></FormField>
<FormField label="调入仓库"><EntitySelect entity="warehouse" value={f.toWarehouseId} onChange={(id,w)=>{setF({...f,toWarehouseId:id,toWarehouseCode:w.code||'',toWarehouseName:w.name||''});}}/></FormField>
