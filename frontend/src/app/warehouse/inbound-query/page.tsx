...
interface Item { id:string;orderNo:string;materialName:string|null;specification:string|null;quantity:string;warehouseName:string|null;totalAmount:string|null;approvalStatus:string;businessStatus:string;receiptDate:string;createdAt:string; }

export default function InboundQueryPage() {
  ...
  return (<TooltipProvider><div className="bg-background rounded-lg border shadow-sm">
    ...
    <div className="overflow-auto"><ErpTable><ErpThead><ErpTh>入库单号</ErpTh><ErpTh>物料</ErpTh><ErpTh>规格</ErpTh><ErpTh>数量</ErpTh><ErpTh>仓库</ErpTh><ErpTh>金额</ErpTh><ErpTh>审批状态</ErpTh><ErpTh>收货日期</ErpTh></ErpThead><ErpTbody>
