...
import { calcLineAmount, calcTotalFromLines, recalcHeaderTotals } from '@/lib/calc';
...
const save=async()=>{
  try{
    ...
    await api.put('/inbound-orders/'+id,payload);router.push('/warehouse/inbound');
...
<FormSection id="l" title="明细信息"><LinesEditor lines={lines} onChange={onLinesChange} columns={INB_COLS}/></FormSection>
</FormLayout>);}
