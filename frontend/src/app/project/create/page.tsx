...
export default function ProjectCreate(){const router=useRouter();useEffect(()=>{api.get('/common/next-code',{params:{entity:'project'}}).then(r=>setF((prev:any)=>({...prev,code:r.data.code})));},[]);const [f,setF]=useState({code:'',name:'',source:''});
