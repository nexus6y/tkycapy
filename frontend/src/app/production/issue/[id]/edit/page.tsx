...
useEffect(()=>{api.get('/production-orders/'+id).then(r=>{const d=r.data;setF({...d,startDate:d.startDate?d.startDate.split('T')[0]:''});});},[id]);
const save=async()=>{await api.put('/production-orders/'+id,f);router.push('/production/issue');};
