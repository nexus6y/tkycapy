...
export default function RouteCreate(){const router=useRouter();const [f,setF]=useState({code:'',name:'',version:'',materialName:'',quantity:''});
const save=async()=>{await api.post('/boms',f);router.push('/production/route');};
return(<FormLayout title="新增工艺路线" onSave={save} sections={[{id:'b',title:'路由信息'}]} activeSection="b"><FormSection id="b" title="路由信息"><FormGrid>
