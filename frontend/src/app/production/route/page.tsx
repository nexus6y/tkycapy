...
export default function Page() {
  return (<TooltipProvider><div className="bg-background rounded-lg border shadow-sm">
    ...
    <ErpTools/><div className="overflow-auto"><ErpTable><ErpThead><ErpTh>编码</ErpTh><ErpTh>名称</ErpTh><ErpTh>创建时间</ErpTh></ErpThead><ErpTbody><ErpEmpty colSpan={3}/></ErpTbody></ErpTable></div>
