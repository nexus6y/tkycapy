...
export default function IssueTracePage() {
  ...
  return (<TooltipProvider><div className="bg-background rounded-lg border shadow-sm">
    <div className="flex items-center justify-between px-4 h-14 border-b border-border">
      <span className="text-sm font-medium text-foreground">领料全追溯</span>
    ...
    <div className="overflow-auto"><ErpTable><ErpThead><ErpTh>订单单号</ErpTh><ErpTh>订单名称</ErpTh><ErpTh>物料</ErpTh><ErpTh>数量</ErpTh><ErpTh>部门</ErpTh><ErpTh>开始日</ErpTh><ErpTh>结束日</ErpTh><ErpTh>业务状态</ErpTh><ErpTh>审批状态</ErpTh><ErpTh>创建时间</ErpTh></ErpThead><ErpTbody>
