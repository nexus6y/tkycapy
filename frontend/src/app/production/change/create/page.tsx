...
export default function ProdChangeCreate(){const router=useRouter();const [f,setF]=useState({orderNo:'',orderName:'',materialName:'',quantity:'',departmentName:'',startDate:'',endDate:'',remark:''});
const save=async()=>{await api.post('/production-orders',f);router.push('/production/change');};
return(<FormLayout title="新增生产变更" onSave={save} sections={[{id:'b',title:'变更信息'}]} activeSection="b"><FormSection id="b" title="变更信息"><FormGrid>
